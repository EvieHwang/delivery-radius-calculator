...
Usage:
    ...
    secret = get_secret("delivery-radius-calculator/prod")
...
def get_secret(secret_name: str, region_name: str = "us-west-2") -> dict[str, Any]:
    """
...
def get_secret_value(
    secret_name: str, key: str, region_name: str = "us-west-2"
) -> str:
    """
